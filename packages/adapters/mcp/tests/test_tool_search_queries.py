...
CASES = [
    ...
    SearchCase("what keys does the daimon agent have", "list_agent_keys"),
    SearchCase("list named agents", "list_agents"),
    ...
    SearchCase("does #growth still use research-bot", "explain_agent_resolution"),
    SearchCase("replace research-bot in this channel with daimon", "set_agent_default"),
    ...
    SearchCase(
        "make the daimon agent answer here instead",
        frozenset(["hand_off_task", "set_agent_default"]),
        frozenset(["hand_off_task", "set_agent_default"]),
    ),
