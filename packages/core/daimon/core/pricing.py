...
# Opus 5.5 rates checked against https://platform.claude.com/docs/en/models/opus-5-5/overview
# on 2026-09-24. Other rows retain their existing rates pending a separate
# catalog review.
