...
reported via GitHub's private vulnerability reporting on this repository
(the **Security** tab, **Report a vulnerability**) — the same private
channel used for security reports. All complaints will be reviewed and
